...
# Build Section
dotnet publish CspReportFunction.sln -c Release -f net6.0 --nologo -o $releaseFoldertmp #-r linux-x64
...
# Test Section
dotnet test CspReportFunction.sln -c Release -f net6.0 --nologo -o $releaseFoldertmp #-r linux-x64
